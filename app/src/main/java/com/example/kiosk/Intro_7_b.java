...
public class Intro_7_b extends AppCompatActivity {
    ...
    public void fastfoodIntro(View view) {
        switch (view.getId()) {
            ...
            case R.id.b1955_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("일구오오버거는 고소한 특별 소스와 신선한 재료로 만들어진 햄버거에요.");
                } else {
            ...
            case R.id.batodi_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("베이컨 토마토 디럭스는 풍부한 베이컨과 신선한 토마토가 들어간 특별한 버거에요.");
                } else {
            ...
            case R.id.bigmc_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("빅맥은 이중 패티와 특별한 소스로 맛을 내는 대표적인 맥도날드 햄버거에요.");
                } else {
            ...
            case R.id.mcchi_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("맥치킨버거는 신선한 치킨 패티로 만든 버거로, 부드러운 맛과 풍미를 선사해요.");
                } else {
            ...
            case R.id.mccri_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("맥크리스피 버거는 고소한 치킨 패티가 특징이며, 바삭한 식감이 돋보여요.");
                } else {
            ...
            case R.id.quater_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("쿼터파운드 치즈 버거는 1/4 파운드 패티와 치즈가 들어간 크고 푸짐한 햄버거로, 고기의 풍미가 느껴져요.");
                } else {
            ...
            case R.id.sanhi_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("맥스파이시 상하이 버거는 특별한 향신료와 소스로 맛을 낸 중국식 매콤한 버거에요.");
                } else {
            ...
            case R.id.susu_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("슈슈버거는 신선한 생선 패티로 만든 생선 버거 시리즈 중 하나에요.");
                } else {
            ...
            case R.id.subi_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("슈비버거는 신선한 생선 패티로 만든 생선 버거 시리즈 중 하나에요.");
                } else {
            ...
            case R.id.bulgogi_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("불고기버거는 불고기 소스로 양념한 햄버거로, 독특한 맛을 즐길 수 있어요.");
                } else {
            ...
            case R.id.cheeze_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("치즈버거는 햄버거에 치즈를 추가한 메뉴로, 담백하고 간단한 맛이 특징이에요.");
                } else {
            ...
            case R.id.ham_lay:
                if (getResources().getConfiguration().locale.getLanguage().equals("ko")) {
                    speakText("햄버거는 맥도날드의 대표적인 햄버거로, 신선한 재료와 소스로 구성돼 있어요.");
                } else {
