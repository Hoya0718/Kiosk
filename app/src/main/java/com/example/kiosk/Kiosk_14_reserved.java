...
public class Kiosk_14_reserved extends AppCompatActivity {
    ...
    public void goto_kiosk_14_reserved_1(View v) {
        Intent goto_kiosk_14_reserved_1 = new Intent(this, Kiosk_14_reserved_1.class);
        if (!personal_Information.isChecked()) {
            ...
            if (three != '0' && three != '1') {
                ...
                startActivity(goto_kiosk_14_reserved_1);
            }
        }
    }
