...
public class Kiosk_R_Hospital_Pay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(Kiosk_R_Hospital_Pay.this, permission_list, 1); // 각자의 클래스명 지정해야합니다.
                                    ...
                                    handler.post(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (text.contains("success")) {
                                                Intent intent = new Intent(Kiosk_R_Hospital_Pay.this, Kiosk_R_Hospital_Pay_Complete.class); //(해당클래스명.this, 다음 클래스명.class)
                                                disconnectBluetooth();
