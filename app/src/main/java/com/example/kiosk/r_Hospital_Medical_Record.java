...
public class r_Hospital_Medical_Record extends AppCompatActivity {
    ...
    public void put_n(View view){
        String current = ssn_txt_1_1.getText().toString();

        switch(view.getId()){

            case R.id.h_btn_1_2:
                ssn_txt_1_1.setTextSize(text_size.getId());
                ssn_txt_1_1.setText(current + '1');
                ssn_txt_1_1.setTextSize(30);

                if (ssn_txt_1_1.length() == 7) {
                    ssn_txt_1_1.setText(current + "-1");
                }
                if (ssn_txt_1_1.length() >= 9)
                    ssn_txt_1_1.setText(current + '*');
                break;

            case R.id.h_btn_2_2:
                ssn_txt_1_1.setTextSize(text_size.getId());
                ssn_txt_1_1.setText(current + '2');
                ssn_txt_1_1.setTextSize(30);
            ...
            case R.id.h_btn_cancel_2:
                ...
                } else if (ssn_txt_1_1.length() == 8) {
                    ssn_txt_1_1.setText(current.substring(0, current.length() - 2));
                } else {
                    ssn_txt_1_1.setText(current.substring(0, current.length() - 1));
                }
                break;
    ...
    public void goto_progress(View v) {
        ...
        if (ssn_txt_1_1.length() != 14) {
            ...
            get_num_2 = ssn_txt_1_1.getText().toString();
